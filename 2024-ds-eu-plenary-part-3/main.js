      ...
      const trailsTableTemplate = {
        columnTemplates: [{
            ...
            formatFunction: ({
                ...
                let component = elevationProfileMap.get(virtualIndex);
                if (component) {
                    component.input = feature;
                    return component.container;
                }
                const container = document.createElement("div");
                component = new ElevationProfile({
                    input: feature,
                    view: view,
                    profiles: [{
                        type: "ground",
                ...
                component.viewModel.highlightEnabled = false;
                elevationProfileMap.set(virtualIndex, component);
                return container;
            },
        },
        {
